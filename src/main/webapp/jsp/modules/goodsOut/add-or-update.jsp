            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">出库管理</li>
                        <li class="breadcrumb-item active">编辑出库</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yuangongId" name="yuangongId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="goodsOutNumber" name="goodsOutNumber" class="form-control"
                                               onchange="goodsOutNumberChickValue(this)"  placeholder="出库数量">
                                    </div>
